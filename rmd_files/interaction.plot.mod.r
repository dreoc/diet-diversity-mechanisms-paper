interaction.plot.mod<-function (x.factor, trace.factor, response, fun = mean, type = c("l", "p", "b", "o", "c","n"), legend = TRUE, 
          ...
          lty = nc:1, col = 1, pch = c(1L:9, 0, letters), xpd = NULL, leg.bg = par("bg"), leg.bty = "n", 
